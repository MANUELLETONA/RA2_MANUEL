...
public class Crear_Vendedores extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (t_codigo.getText().isEmpty() || t_nombre.getText().isEmpty() 
           || t_caja.getText().isEmpty() || t_pass.getText().isEmpty() || 
           t_ventas.getText().isEmpty()){
    ...
    public void Guardar (){
        ...
        Administrador.vendedores.add(new Vendedores(Integer.parseInt(t_codigo.getText()), t_nombre.getText(), 
                       Integer.parseInt(t_caja.getText()), Integer.parseInt(t_ventas.getText()), 
                       generos, t_pass.getText()));
