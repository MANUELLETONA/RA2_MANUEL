...
public class logins extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(t_contra, javax.swing.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(97, 97, 97)
    ...
    private void verificar(){
        if (t_usuario.getText().equals("admin") && t_contra.getText().equals("admin")){
         Administrador ap = new Administrador();
         ap.setVisible(true);
            
        }else {
            for (Vendedores ven: Administrador.vendedores){
             if (t_usuario.getText().equals(ven.getNombre()) && t_contra.getText().equals(ven.getPass())){
